...
--Esablish a relationship between classification and invetory
ALTER TABLE IF EXISTS public.invetory
...
ALTER TYPE public.yes_no OWNER TO cse340db;


CREATE TABLE IF NOT EXISTS public.purchase (
    purchased_id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    inv_id INT NOT NULL,
    account_id INT NOT NULL,
    purchase_date DATE NOT NULL DEFAULT CURRENT_DATE,
    purchase_time TIME NOT NULL DEFAULT CURRENT_TIME,
    purchased yes_no NOT NULL DEFAULT 'Yes'::yes_no,

    CONSTRAINT purchase_pkey PRIMARY KEY (purchased_id),
    CONSTRAINT fk_account_id FOREIGN KEY (account_id) REFERENCES public.account (account_id),
    CONSTRAINT fk_inv_id FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id)
);
